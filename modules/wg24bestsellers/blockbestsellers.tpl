...
<!-- MODULE Block best sellers -->
  ...
  <div class="related-block"  id="best-sellers_block_right">
    <div class="block-title">{l s='Top sellers' mod='blockbestsellers'}</div>
    <div class="block-content">
        <div class=" jcarousel-skin-tango4">
            <div class="jcarousel-container jcarousel-container-horizontal">
                <div class="jcarousel-clip jcarousel-clip-horizontal">
                      {if $best_sellers && $best_sellers|@count > 0}  
                    <ul style="overflow: hidden; position: relative; top: 0px; margin: 0px; padding: 0px; left: 0px; width: 1844px;" id="mycarousel4" class="products-grid last even jcarousel-list jcarousel-list-horizontal">
