...
{if $products}
    {if !$refresh}
        ...
        <ul class="clearfix display_list">
            <li>
                <a  id="hideBoughtProducts" class="button submit button_account" href="#" onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="{l s='Hide products' mod='blockwishlist'}">
                    <span>{l s='Hide products' mod='blockwishlist'}</span>
                </a>
                <a id="showBoughtProducts" class="button submit button_account" href="#" onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="{l s='Show products' mod='blockwishlist'}">
                    <span>{l s='Show products' mod='blockwishlist'}</span>
                </a>
            </li>
            {if count($productsBoughts)}
                <li>
                    <a id="hideBoughtProductsInfos" class="button submit button_account" href="#" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Hide products' mod='blockwishlist'}">
                        <span>{l s="Hide bought product's info" mod='blockwishlist'}</span>
                    </a>
                    <a id="showBoughtProductsInfos" class="button submit button_account" href="#" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="{l s='Show products' mod='blockwishlist'}">
                       <span> {l s="Show bought product's info" mod='blockwishlist'}</span>
                    </a>
                </li>
            {/if}
        </ul>
        <p class="wishlisturl form-group">
            ...
            <input type="text"  style="  color: #333333;height: 31px;width: 296px;" class="form-control button" value="{$link->getModuleLink('blockwishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}" readonly="readonly"/>
        </p>
        <p class="submit">
                        ...
                        <div class="col-xs-6 col-sm-12">
                            <div class="product_image">
                                <a href="{$link->getProductlink($product.id_product, $product.link_rewrite, $product.category_rewrite)|escape:'html':'UTF-8'}" title="{l s='Product detail' mod='blockwishlist'}">
                                    <img class="replace-2x img-responsive"  src="{$link->getImageLink($product.link_rewrite, $product.cover, 'home_default')|escape:'html':'UTF-8'}" alt="{$product.name|escape:'html':'UTF-8'}" width="230"/>
                                </a>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-12">
                            <div class="product_infos">
                                ...
                                <div class="wishlist_product_detail">
                                    <p class="form-group">
                                        ...
                                        <input type="text" class="form-control grey qty" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$product.quantity|intval}" size="3"/>
                                    </p>
