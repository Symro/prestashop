<header>
  <div class="header">
    ...
    <div class="right">
      ...
      <div class="toplinks">
                <ul class="links">
                <li class="myaccount" ><a href="{$link->getPageLink('my-account', true)}" title="{l s='my account' mod='wg24headerpermanentlinks'}" class="top-link-my-acconut">{l s='my account' mod='wg24headerpermanentlinks'}</a></li>
                
                <li   class="wishlist"><a href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}" title="{l s='My Wishlist' mod='wg24headerpermanentlinks'}" class="top-link-my-wishlist">{l s='My Wishlist' mod='wg24headerpermanentlinks'}</a></li>
                <li><a href="{$link->getPageLink('products-comparison')}" title="{l s='Comparer' mod='wg24headerpermanentlinks'}" class="top-link-my-comparer">{l s='Comparer' mod='wg24headerpermanentlinks'}</a></li>
