...
<form class="box" id="compare_shipping_form" method="post" action="#" >
	<fieldset id="compare_shipping">
		...
		<div class="form-group last">
			<label for="zipcode">{l s='Zip/postal code' mod='carriercompare'}</label><br>
			<input class="form-control input-text" type="text" name="zipcode" id="zipcode" value="{$zipcode|escape:'html':'UTF-8'}"/> ({l s='Needed for certain carriers.' mod='carriercompare'})
		</div>
		...
		<p class="alert alert-warning text-center" id="noCarrier" style="display: none;">
            ...
            <button class="btn btn-default button get-quote" id="carriercompare_submit" type="button" name="carriercompare_submit">
            	<span>{l s='Update cart' mod='carriercompare'}</span>
            </button>
            <button id="update_carriers_list" type="button" class="btn btn-default button get-quote">
