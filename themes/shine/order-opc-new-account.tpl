...
<ol  class="one-page-checkout">
    <li class="section" id="opc-login">
        <div class="step-title">
            <span class="number step-num">1</span> <h3 class="one_page_heading">{l s='Account'}</h3>
            <!--<a href="#">Edit</a>-->
        </div>
        <div style="" class="step a-item" >
            ...
            <div id="opc_new_account" class="opc-main-block">
                ...
                <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box std">
                    <fieldset>
                        ...
                        <div id="login_form_content" style="display:none;">
                            ...
                            <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button create-account button-medium"><span>{l s='Login'}</span></button>
                        </p>
                    </div>
                </fieldset>
            </form>
                    ...
                    <div class="box">
                        ...
                        <div id="opc_account_choice" class="row">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <p class="opc-button">
                                    <button type="submit" class="button create-account button button-medium exclusive" id="opc_guestCheckout"><span>{l s='Guest checkout'}</span></button>
                                </p>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <p class="opc-button">
                                    <button type="submit" class="button create-account button-medium exclusive" id="opc_createAccount"><span>{l s='Create an account'}</span></button>
                                </p>
                            </div>
                        </div>
                        <div id="opc_account_form" class="unvisible">
                            ...
                            <div class="submit opc-add-save clearfix">
                                ...
                                <button type="submit" name="submitAccount" id="submitAccount" class="button submit button button-medium"><span>{l s='Save'}</span></button>
