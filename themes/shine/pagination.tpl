            ...
            <ul class="pagination">
                {if $p != 1}
                    ...
                    <li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_previous">
                        <a {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}" class="button">
                ...
                {if $start==3}
                    <li>
                        <a {$no_follow_text}  href="{$link->goPage($requestPage, 1)}"  class="button">
                            <span>1</span>
                        </a>
                    </li>
                    <li>
                        <a {$no_follow_text}  href="{$link->goPage($requestPage, 2)}" class="button">
                            <span>2</span>
                        </a>
                    </li>
                {/if}
                ...
                {section name=pagination start=$start loop=$stop+1 step=1}
                    ...
                    {else}
                        <li>
                            <a {$no_follow_text} href="{$link->goPage($requestPage, $smarty.section.pagination.index)}" class="button">
                ...
                {if $pages_nb>$stop+2}
                    ...
                    <li>
                        <a href="{$link->goPage($requestPage, $pages_nb)}" class="button">
                ...
                {if $pages_nb==$stop+2}
                    <li>
                        <a href="{$link->goPage($requestPage, $pages_nb-1)}" class="button">
                ...
                {if $pages_nb > 1 AND $p != $pages_nb}
                    ...
                    <li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_next">
                        <a {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}" class="button">
