            ...
            <ol  class="one-page-checkout">
                <li class="section" id="opc-login">
                    <div class="step-title">
                        <span class="number step-num">2</span> <h3 class="one_page_heading">{l s='Delivery methods'}</h3>
                        <!--<a href="#">Edit</a>-->
                    </div>
                ...
                <p class="cart_navigation clearfix">
                    ...
                    {if !$is_guest}
                        {if $back}
                            <a 
                                ...
                                title="{l s='Previous'}"
                                class="button continue btn btn-default">
                    ...
                    {else}
                        <a
                            ...
                            title="{l s='Previous'}"
                            class="button continue button-exclusive btn btn-default">
                            {l s='Continue shopping'}
                        </a>
                    {/if}
                    {if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
                        <button type="submit" name="processCarrier" class="button proceed-checkout standard-checkout button-medium right">
                            <span>
