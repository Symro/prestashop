    ...
    <ol id="checkoutSteps" class="one-page-checkout">
        <li class="section" id="opc-login">
            <div class="step-title">
                <span class="number step-num">3</span> <h3 class="one_page_heading">{l s='Please choose your payment method'}</h3>
                <!--<a href="#">Edit</a>-->
            </div>
                    ...
                    {if $HOOK_PAYMENT}
                        {if !$opc}
                            <div id="order-detail-content" class="table_block table-responsive">
                                <table id="cart_summary" class="data-table cart-table table-bordered">
                                    <colgroup>
                                        <col width="1">
                                        <col>
                                        <col >
                                    ...
                                    <thead>
                                        <tr>
                                            <th rowspan="1" class="hidden-table cart_product first_item">{l s='Product'}</th>
                                            <th  rowspan="1" class="cart_description item"><span class="nobr">{l s='Description'}</span></th>
                                            <th  rowspan="1" class="hidden-phone cart_availability item">{l s='Avail.'}</th>
                                            <th class="a-left hidden-table cart_unit item"><span class="nobr">{l s='Unit price'}</span></th>
                                            <th rowspan="1" class="a-left cart_quantity item">{l s='Qty'}</th>
                                            <th rowspan="1" class="a-left cart_total last_item">{l s='Total'}</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        {if $use_taxes}
...
{if !$opc}
    <p class="cart_navigation clearfix">
        <a href="{$link->getPageLink('order', true, NULL, "step=2")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button continue btn btn-default">
