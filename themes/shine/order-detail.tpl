...
<div class="box box-small clearfix">
    {if isset($order)}
        ...
        <form id="submitReorder" action="{if isset($opc) && $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" class="submit">
            ...
            <a href="#" onclick="$(this).closest('form').submit(); return false;" class="button btn-update button-medium pull-right"><span>{l s='Reorder'}</span></a>
            <p class="dark">
...
{if count($order_history)}
    ...
    <div class="table_block">
        ...
        <table class="data-table cart-table etail_step_by_step" id="shopping-cart-table">
            <colgroup>
                <col width="1">
                <col width="1">
            </colgroup>
...
<div class="adresses_bloc">
    <div class="row">
        <div class="col-xs-12 col-sm-6 left"{if $order->isVirtual()} style="display:none;"{/if}>
...
{if !$is_guest}<form action="{$link->getPageLink('order-follow', true)|escape:'html':'UTF-8'}" method="post">{/if}
    <div id="order-detail-content" class="table_block table-responsive">
        ...
        <table class="data-table cart-table table table-bordered" id="shopping-cart-table">
            <colgroup>
                <col width="1">
                <col width="1">
                <col width="1">
...
{if $order->getShipping()|count > 0}
    <table class="data-table cart-table table table-bordered footab" id="shopping-cart-table">
        <colgroup>
            <col width="1">
            <col width="1">
            <col width="1">
...
{if !$is_guest}
    {if count($messages)}
        ...
        <div class="table_block">
            ...
            <table class="detail_step_by_step table table-bordered data-table cart-table">
                <colgroup>
                    <col width="1">
                    <col width="1">
                </colgroup>
    ...
    <form action="{$link->getPageLink('order-detail', true)|escape:'html':'UTF-8'}" method="post" class="std" id="sendOrderMessage">
        ...
        <div class="submit">
            ...
            <button type="submit" name="submitMessage" class="button submit button-medium"><span>{l s='Send'}</span></button>
        </div>
    </form>
{else}
