...
{else}
    ...
    <form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="contact-form-box std" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="submit">
                <button type="submit" name="submitMessage" id="submitMessage" class="
                        button submit btn-default button-medium"><span>{l s='Send'}</span></button>
            </div>
        </fieldset>
    </form>
{/if}
