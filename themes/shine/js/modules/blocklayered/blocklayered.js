...
function reloadContent(params_plus)
{
	...
	if (!ajaxLoaderOn)
	{
	   $('#product_list-grid_box').prepend($('#layered_ajax_loader').html());
               
            $('#products-grid').css('opacity', '0.7');
	...
	ajaxQuery = $.ajax(
	{
		...
		success: function(result)
		{
			...
			$('.category-product-count, .heading-counter').html(result.categoryCount);
                    ...
                    var prod_list_view = $('.products-list').is(':visible');
                    var prod_grid_view = $('.products-grid').is(':visible');
                    $('#product_list-grid_box').replaceWith(utf8_decode(result.productList));
                    if(prod_list_view){
                        $(".category-products ol.products-list").show();
                        $(".category-products ul.products-grid").hide();
                    }
                    else if(prod_grid_view){
                ...
                if ($.browser.msie) // Fix bug with IE8 and aliasing
                    $('#products_list').css('filter', '');
                $('#products-grid').css('filter', '');
...
function updateProductUrl()
{
    ...
    if (typeof(param_product_url) != 'undefined' && param_product_url != '' && param_product_url !='#') {
        $.each($('ol#product_list li.ajax_block_product .product_img_link,'+
            'ol#product_list li.ajax_block_product .item-title a,'+
            'ol#product_list li.ajax_block_product .product_desc a,'+
            'ol#product_list li.ajax_block_product .lnk_view ,'+ 'ul#products-grid li.ajax_block_product .product_img_link,'+
            'ol#products-grid li.ajax_block_product h3 a,'+
            'ol#products-grid li.ajax_block_product .product_desc a,'+
            'ol#products-grid li.ajax_block_product .lnk_view'), function() {
