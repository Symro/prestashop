    ...
    {else}
        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std">
            <fieldset>
                ...
                <div class="required form-group clear">
                ...
                {/if}
                <div class="form-group">
                    <button type="submit" name="submitIdentity" class="button submit button-medium">
                        <span>{l s='Save'}</span>
                    </button>
                </div>
...
<ul class="footer_links clearfix">
    ...
    <a class="button continue button-small" href="{$link->getPageLink('my-account', true)}">
        <span>
            {l s='Back to your account'}
        </span>
    </a>

    <a class="button continue button-small" href="{$base_dir}">
        <span>
            {l s='Home'}
        </span>
    </a>
