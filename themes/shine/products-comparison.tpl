...
<div class="login_page">
    ...
    {if $hasProduct}
        <div class="products_block table-responsive">
            <table id="product_comparison" class="table table-bordered data-table cart-table">
                <tr>
                    ...
                    {foreach from=$products item=product name=for_products}
                        ...
                        <td class="ajax_block_product comparison_infos product-block product-{$product->id}">
                            ...
                            <div class="prices-container price-box">
                                {if isset($product->show_price) && $product->show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
    ...
    <ul class="footer_link">
        ...
        <a class="button continue btn-default" href="{$base_dir}">
