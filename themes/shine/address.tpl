...
<button type="submit" name="submitAddress" id="submitAddress" class="button continue button-medium">
    <span>
        {l s='Save'}

    </span>
</button>
<button class="button continue button-small right" onclick="location.href='{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}'">
