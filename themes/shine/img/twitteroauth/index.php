...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	...
	public function __construct() {
		...
		$this->message = '';
                $this->consumer_key =Configuration::get('wg24_twit_consu_key_shine');
                $this->consumer_secret =Configuration::get('wg24_twit_consu_secrt_shine');
                $this->user_token =Configuration::get('wg24_twit_uconsu_token_shine');
                 $this->user_secret =Configuration::get('wg24twit_uconsu_secret_shine');
