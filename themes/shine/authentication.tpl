...
<div class="login_page">
    <div class="page-title">
        <h2>{if !isset($email_create)}{l s='Authentication'}{else}{l s='Create an account'}{/if}</h2>
    </div>
...
<fieldset class="col2-set">
    ...
    <div class="col-1 new-users"><strong>{l s="New Customers"}</strong>
        <div class="content">
            <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
                ...
                <div class="form_content clearfix">
                    ...
                    <ul class="form-list">
                        <li class="form-group">
                            <label for="email_create">{l s='Email address'}<span class="required">*</span></label>
                            <br>
                            <input type="text" class="is_required validate account_input form-control input-text" data-validate="isEmail" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|stripslashes}{/if}" />
                        </li>

                    </ul>
                    <div class="buttons-set submit" >
                    {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
                    <button class="button-medium exclusive button create-account" type="submit" id="SubmitCreate" name="SubmitCreate">
                        <span>
...
<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
    <div class="col-2 registered-users"><strong>{l s='Already registered?'}</strong>
        <div class="content form_content">
            <p>{l s="If you have an account with us, please log in."}</p>
            <ul class="form-list ">
                <li class="form-group">
                    <label for="email">{l s='Email address'}<span class="required">*</span></label>
                    <br>
                    <input class="is_required validate account_input form-control input-text" data-validate="isEmail" type="text" id="email" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}" />
                </li>
                <li  class="form-group">
                    <label for="passwd">{l s='Password'}<span class="required">*</span></label>
                    <br>
                    <input class="is_required validate account_input form-control input-text" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="{if isset($smarty.post.passwd)}{$smarty.post.passwd|stripslashes}{/if}" />
                </li>
            </ul>
            ...
            {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
            <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button login btn-default button-medium">
                <span>
                    {l s='Sign in'}
                </span>
            </button>
            <a class="forgot-word" href="{$link->getPageLink('password')|escape:'html':'UTF-8'}" title="{l s='Recover your forgotten password'}" rel="nofollow">{l s='Forgot your password?'}</a>
        </div>
    </div> 
</div>
</form> 
...
{else}
    ...
    {/if}-->
        <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
            ...
            {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
            <button type="submit" name="submitAccount" id="submitAccount" class="button continue button button-medium">
