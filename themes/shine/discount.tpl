...
<div class="login_page">
    ...
    {if isset($cart_rules) && count($cart_rules) && $nb_cart_rules}
        <table class="discount table table-bordered footab data-table cart-table">
            <colgroup>
                <col width="1">
                <col width="1">
                <col width="1">
...
<ul class="footer_links clearfix">
    <a class="button continue button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
        <span>
