    ...
    <div class="product-view"  itemscope itemtype="http://schema.org/Product">
        <div class="product-essential">
            <div class="primary_block row" itemscope itemtype="http://schema.org/Product">
                ...
                <div class="product-img-box pb-left-column">
                    ...
                    <div id="image-block" class="clearfix">
                        ...
                        {if isset($images) && count($images) > 0}
                            <!-- thumbnails -->
                            <div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if} more-views">
                                ...
                                {/if}
                                <div id="thumbs_list">
                                    <ul id="thumbs_list_frame" class="more">
                                        {if isset($images)}
                ...
                <div class="product-shop pb-right-column">
        ...
        <div class="add-to-cart">
            ...
            {if !$PS_CATALOG_MODE}
                <p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
                    ...
                    <input type="text" name="qty" id="quantity_wanted" class="input-text qty" value="{if isset($quantityBackup)}{$quantityBackup|intval}{else}{if $product->minimal_quantity > 1}{$product->minimal_quantity}{else}1{/if}{/if}" />
                    <button type="button" class="button-arrow button-up">{l s="Increase"}</button>
                    <button type="button" class="button-arrow button-down">{l s="Decrease"}</button>
                </p>
            ...
            <div class="tab-box">
                <ul class="product-tabs">
                    ...
                    {if isset($accessories) && $accessories}
                        <li> <a href="" class="tabLink" id="cont-3">{l s='Accessories'}</a> </li>
                    {/if}
                {if $attachments}<li><a href="" class="tabLink" id="cont-4">{l s='Download'}</a></li>{/if}
            {if isset($product) && $product->customizable}<li><a href="" class="tabLink" id="cont-5">{l s='Product customization'}</a></li>{/if}
            {$HOOK_PRODUCT_TAB}
        ...
        <div class="tabcontent paddingAll hide" id="cont-2-1">
            ...
            <div class="std">
                {if isset($product) && $product->description}
                    <!-- full description -->
                    <div  class="rte"><p>{$product->description}</p></div>
                {/if}
            </div>
        </div>
    {/if}   
                                ...
                                <li class="item product-box ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
                                    <div class="product_desc">
                                        <a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product-image product_image">
                                            <img class="lazyOwl" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'home_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}" width="50" height="50"/>
                                        </a>
...
{if isset($product) && $product->customizable}
    <!--Customization -->
    <div class="tabcontent paddingAll" id="cont-5-1">
        <!--h3></h3-->
        <div class="std">
                    ...
                    <ul id="text_fields">
                        ...
                        {/if}
                            <div class="tabcontent paddingAll hide" id="cont-6-1">
                                <!--h3></h3-->
                                <div class="std">
                                    {$webgroup24.wg24_p_tab_content_shine|html_entity_decode}
                                </div>
                            </div>
